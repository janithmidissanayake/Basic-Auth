...
public class WebSecurityConfiguration {
    @Autowired
    private UserDetailsService userDetailsService; // Inject your custom UserDetailsService
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/employee").permitAll() // Allow all requests to /api/employee
